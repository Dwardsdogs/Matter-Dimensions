function getDimensionBoostCost(type) {
	...
	if (type == "dimension") {
		if (game.dimensionBoosts.lte(0)) {
			return "4th"
		} else if (game.dimensionBoostLevel.lte(1)) {
			return "5th"
		} else if (game.dimensionBoostLevel.lte(2)) {
			return "6th"
		} else if (game.dimensionBoostLevel.lte(3)) {
			return "7th"
		} else if (game.dimensionBoostLevel.gte(4)) {
			return "8th"
		}
	}
}
